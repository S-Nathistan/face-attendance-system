...
def compress_image(image_bytes, max_size=(150, 150)):
    try:
        ...
        image.save(output_buffer, format='JPEG', quality=75)  # Reduce quality to compress
...
class SearchEmployees(Resource):
    ...
    def get(self):
        ...
        sql_query = f"""
            ...
            WHERE e.emp_name LIKE ? OR e.emp_id LIKE ?
        ...
        for row in cursor.fetchall():
            ...
            results.append({
                ...
                'status': att_type if att_type != 'None' else 'newly added',
                'date': date,
                'time': time,
